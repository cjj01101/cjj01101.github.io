  ...
  a.fn.qrcode = function (k) {
    ...
    e.prototype = {
        ...
        if (1 > this.typeNumber) {
          for (var j = 1, j = 1; 40 > j; j++) {
            ...
            for (l = 0; l < this.dataList.length; l++) {
              o = this.dataList[l],
              m.put(o.mode, 4),
              m.put(o.getLength(), i.getLengthInBits(o.mode, j)),
              o.write(m)
            }
      ...
      setupTypeNumber: function (j) {
        ...
        for (l = 0; 18 > l; l++) {
          h = !j && 1 == (m >> l & 1),
          this.modules[l % 3 + this.moduleCount - 8 - 3][Math.floor(l / 3)] = h
        }
      },
      setupTypeInfo: function (j, o) {
        ...
        for (h = 0; 15 > h; h++) {
          l = !j && 1 == (m >> h & 1),
          8 > h ? this.modules[8][this.moduleCount - h - 1] = l : 9 > h ? this.modules[8][15 - h - 1 + 1] = l : this.modules[8][15 - h - 1] = l
        }
